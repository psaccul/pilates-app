    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{textAlign:'center', marginBottom:32}}>
          <div style={{fontFamily:'var(--font-display)', fontSize:28, fontWeight:300, color:'var(--dark)'}}>
            Studio
          </div>
          <div style={{fontSize:10, letterSpacing:'0.2em', color:'var(--mg-m)', textTransform:'uppercase', marginTop:4}}>
            Pilates Reformer
          </div>
        </div>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="form-row">
            ...
            <input className="form-inp" type="password" value={password}
              onChange={e => setPassword(e.target.value)} required placeholder="••••••••" />
          </div>
          {error && (
            <div style={{fontSize:12, color:'#B03030', marginBottom:12, padding:'8px 12px',
