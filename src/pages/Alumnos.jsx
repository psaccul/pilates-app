...
export default function Alumnos({ esAdmin }) {
  ...
  function openModal(alumno = null) {
    setForm(alumno ? { id:alumno.id, nombre:alumno.nombre, apellido:alumno.apellido, telefono:alumno.telefono||'', plan:alumno.plan, frecuencia:alumno.frecuencia||'', instructor_id:alumno.instructor_id||'', notas:alumno.notas||'' } : emptyForm)
    setModal(true)
  }
  ...
  async function handleSave() {
    ...
    setSaving(true)
    const payload = { nombre:form.nombre, apellido:form.apellido, telefono:form.telefono, plan:form.plan, frecuencia:form.frecuencia, instructor_id:form.instructor_id||null, notas:form.notas, activo:true }
            ...
            <table className="tbl">
              <thead>
                <tr>
                  ...
                  <th>Plan</th><th>Instructor</th><th>Teléfono</th><th>Notas</th><th>Estado</th><th>Acciones</th>
                </tr>
              </thead>
              <tbody>
                ...
                {filtered.map(a => {
                  ...
                  return (
                    <tr key={a.id}>
                      ...
                      <td style={{whiteSpace:'nowrap'}}>{a.telefono||'—'}</td>
